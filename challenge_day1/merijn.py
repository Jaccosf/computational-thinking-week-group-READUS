...
def merijn_act_2():
    return f"{char_3} shat back at {char_1}, asking why {char_1}’s brother was so eager to cover for him. {char_1}’s face got red, and he accused {char_3} of grasping at straws. {char_4} chimed in, saying that {char_3}’s alibi seemed too convenient, like he was trying to seem innocent. {char_3} was getting frustrated, feeling trapped between {char_1} and {char_4}’s suspicions."

def merijn_act_3():
    return f"{char_3} and {char_1} pressed {char_4} harder, sking why he lied about the gym. {char_4} finally broke down and admitted his alibi was fake, but he insisted he didn’t kill {char_2}. He said he was with someone he shouldn’t have been and didn’t want anyone to know. {char_1} and {char_3} exchanged a look — {char_4} was lying about one thing, but was he lying about the murder?"