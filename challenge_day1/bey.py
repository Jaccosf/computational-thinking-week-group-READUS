...
def act1p3(char_1, char_3, char_4):
    return f"{char_1}, on the other hand, was loud about his innocence. He kept telling everyone he had an alibi, and his brother even showed up to confirm it. But {char_3} wasn’t buying it — he thought {char_1} was trying too hard to shift suspicion. {char_4}, noticing {char_2()}’s intensity, wondered if it was just a cover for something darker."

def act2p3(char_1, char_3, char_4):
...
def act3p3(char_1, char_3, char_4):
